  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center animate-[logoFadeIn_2s_ease-out_forwards]">
        ...
        <p className="text-white/90 font-sans text-base font-light tracking-[2px] m-0 opacity-0 text-shadow animate-[subtitleFadeIn_1s_ease-out_2s_forwards] [text-shadow:0_0_15px_rgba(255,255,255,0.3)]">
