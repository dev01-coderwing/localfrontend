...
// GET QUESTIONS
export const getCompatibilityQuestionsThunk =
  createAsyncThunk(
...
// SUBMIT ANSWER
export const submitCompatibilityAnswerThunk =
  createAsyncThunk(
...
const compatibilitySlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      // GET QUESTIONS
      .addCase(
        getCompatibilityQuestionsThunk.pending,
        (state) => {
      ...
      .addCase(
        getCompatibilityQuestionsThunk.fulfilled,
        (state, action) => {
      ...
      .addCase(
        getCompatibilityQuestionsThunk.rejected,
        (state, action) => {
