  ...
  return (
    <div className="flex items-center justify-center h-screen bg-[var(--bg)] text-[var(--text)] px-6">
      <div className="max-w-md w-full text-center">
        ...
        <button
          onClick={nextSlide}
          className="w-full py-4 rounded-full text-[var(--text)] font-medium bg-gradient-to-r from-[#D79098] to-[#5F7BF4] hover:opacity-90 transition"
        >
          {t("next")}
        </button>
      </div>
