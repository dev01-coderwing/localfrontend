...
const UsageMeter = ({ used, total, percent, remaining }) => (
  <article className=" p-6 rounded-[24px] shadow-sm border border-white">
    <div className="flex justify-between items-start mb-5 ">
      <div>
        <p className="text-[10px] font-black text-[var(--text)] uppercase tracking-widest mb-1.5">Time Usage</p>
...
export default function ProfileLucasDetails() {
  const { usage, allocations, rules, actions, headerTitle } = LUCAS_DETAILS_DATA;
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-8">
        <section className="bg-[var(--bg-card)]/10 rounded-[24px] p-6 md:p-10 shadow-inner">
          ...
          <header className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-2xl font-black text-[var(--text-dim)] tracking-tight">Setting</h1>
          </header>
 
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              <h2 className="text-lg font-black text-[var(--text-dim)] ml-1">{headerTitle}</h2>
              ...
              <div className="bg-[var(--bg-background)] p-6 md:p-8 rounded-[32px] space-y-6 border border-[var(--border)] shadow-sm">
                ...
                <div className="space-y-4">
                  <p className="text-[10px] font-black text-[var(--text-dim2)] uppercase tracking-widest ml-1">Plan Allocation</p>
