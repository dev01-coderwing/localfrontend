  ...
  return (
    <div className={`flex items-center  gap-4 p-4 transition-colors hover:bg-gray-50/50 ${!isLast ? 'border-b border-[var(--border)]' : ''}`}>
      ...
      <div>
        ...
        <p className="text-[11px] text-gray-400 font-medium mt-0.5">{feature.desc}</p>
      </div>
    </div>
  );
};
...
export default function ProfileSubscription() {
  const { planName, status, renewalDate, price, billingCycle, features, actions } = SUBSCRIPTION_DATA;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-[var(--card)] p-6 md:p-8 rounded-[32px] space-y-6 border border-white/40 shadow-sm">
                <h2 className="text-lg font-semibold text-[var(--text)] ml-1">Subscription</h2>
                {/* Premium Plan Card */}
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10">
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 px-3 py-1 bg-white/20 rounded-full w-fit backdrop-blur-sm border border-white/10">
                        ...
                        <span className="text-[10px] font-black tracking-widest uppercase">Current Plan</span>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-bold opacity-90">Renews {renewalDate}</span>
                        </div>
                      </div>
                    </div>
                ...
                {/* Features Section */}
                <div className="space-y-4">
                  <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Your Features</p>
