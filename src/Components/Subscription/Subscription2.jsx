...
const mini = '/Image/min.png'
const small = '/Image/small.png'
const large = '/Image/large.png'
const medium = '/Image/medium.png'
const XL = '/Image/XL.png'
const lucascope = '/Image/lucascope.png'
const lucascopeInfinity = '/Image/lucascopeInfinity.png'
const leDigestif = '/Image/Le Digestif.png'
const coin = '/Image/coin.png'
const lucas = '/Image/lucasTime.png'
